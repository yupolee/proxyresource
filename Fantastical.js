/*
QX: ^https:\/\/api\.flexibits\.com\/v1\/(auth|account)\/(device|details|appstore-receipt)\/$ url script-response-body fantastical.js
Surge: http-response ^https:\/\/api\.flexibits\.com\/v1\/(auth|account)\/(device|details|appstore-receipt)\/$ requires-body=1,max-size=0,script-path=resources/js/fantastical.js
...
if(url.indexOf('details')!=-1){
  ...
  obj.subscription={
		...
		"uuid": "d2ct7b35-g890-3542-893n-886abc372767",
